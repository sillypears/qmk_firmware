...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
      /* Base Layer
   * .-----------------------------------------------------------------------------.   .-------.
   * | GESC| Q   | W   | E   | R   | T   | Y   | U   | I   | O   | P   | [{  | BKSP|   |RGB TOG|
   * |-----------------------------------------------------------------------------|   '-------'
   * | LCTL | A   | S   | D   | F   | G   | H   | J   | K   | L   | ;  | ' |  ENT  |
   * |-----------------------------------------------------------------------------'  .------.
   * | LSFT | Z   | X   | C   | V   | B   | N   | M   | ,<  | .>  | /? | RSFT |       | UP   |
   * |-----------------------------------------------------------------------' .------|------|-----.
   * | TAB  | APP | LGUI | LALT | MO(1)   | SPACE    | RALT | MO(2}| DEL |     | LF   | DN   | RT  |
   * '-------------------------------------------------------------------'     '-------------------'
   */
    ...
    [0] = LAYOUT_ortho(
        ...
        KC_TAB, KC_APP, KC_LGUI, KC_LALT, MO(1), KC_SPC, KC_SPC, MO(2), KC_RALT, MO(2), KC_DEL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
      /* First Layer
   * .-----------------------------------------------------------------------------.   .-------.
