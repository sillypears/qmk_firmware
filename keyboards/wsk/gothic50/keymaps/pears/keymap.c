...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,            MO(2),   KC_N,    KC_M,    KC_COMM, KC_DOT,  LCTL_T(KC_SLSH),      KC_UP,       KC_DEL, \
    KC_APP,         KC_LGUI,          KC_LALT, MO(1),   KC_BSPC,    LT(1,KC_SPC), KC_RALT, KC_RCTL,                        KC_LEFT, KC_DOWN, KC_RGHT \
  ),
  ...
  [1] = LAYOUT(
    ...
    KC_TAB, _______,          _______, _______, _______,       _______, _______, _______,                            KC_HOME, KC_PGDN, KC_END \
  ),
