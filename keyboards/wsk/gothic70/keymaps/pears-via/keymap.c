...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    KC_GESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_HOME,  KC_END,          KC_PSCR, \
    ...
    KC_LCTL, KC_LGUI,  KC_LALT,         KC_SPACE,  MO(_FN),                        KC_BSPACE,           KC_RGUI, KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT           \
  ),
